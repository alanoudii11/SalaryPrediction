...
+======================+=================+=========================+
| Age                  | integer         | The person's age in     |
|                      |                 | years.                  |
+----------------------+-----------------+-------------------------+
| workclass            | categorical     | Represents the          |
|                      |                 | employment status.      |
+----------------------+-----------------+-------------------------+
| fnlwgt               | integer         | The final weight of how |
|                      |                 | much of the population  |
|                      |                 | it represents.          |
+----------------------+-----------------+-------------------------+
| education            | categorical     | Highest level of        |
|                      |                 | education.              |
+----------------------+-----------------+-------------------------+
| education-num        | integer         | Highest level of        |
|                      |                 | education in numerical  |
|                      |                 | form.                   |
+----------------------+-----------------+-------------------------+
| marital-status       | categorical     | Represents the marital  |
|                      |                 | status.                 |
+----------------------+-----------------+-------------------------+
| occupation           | categorical     | Represents the          |
|                      |                 | occupation of the       |
|                      |                 | individual.             |
+----------------------+-----------------+-------------------------+
| relationship         | categorical     | Represents the          |
|                      |                 | relationship status.    |
+----------------------+-----------------+-------------------------+
| race                 | categorical     | Represents the person's |
|                      |                 | race.                   |
+----------------------+-----------------+-------------------------+
| sex                  | binary          | The person's gender.    |
+----------------------+-----------------+-------------------------+
| capital-gain         | integer         | Represents the capital  |
|                      |                 | gain.                   |
+----------------------+-----------------+-------------------------+
| capital-loss         | integer         | Represents the capital  |
|                      |                 | loss.                   |
+----------------------+-----------------+-------------------------+
| hours . per.week     | continuous      | Represents the hours    |
|                      |                 | the person works per    |
|                      |                 | week.                   |
+----------------------+-----------------+-------------------------+
| native -country      | categorical     | The person's country.   |
+----------------------+-----------------+-------------------------+
| salary               | binary          | The class label; it     |
...
| width        |              |                |              |
+--------------+--------------+----------------+--------------+
| Total        | 94215.99     | 86246.29       | 79699.02     |
| wi           |              |                |              |
| thin-cluster |              |                |              |
| sum of       |              |                |              |
| square       |              |                |              |
...
+--------------+--------------+----------------+--------------+
| V            | ![](image    | ![](ima        | ![](image    |
| isualization | s/k2-03.png) | ges/k3-01.png) | s/k4-02.png) |
|              | {width="137" |                | {width="134" |
|              | h            |                | h            |
|              | eight="118"} |                | eight="122"} |
+--------------+--------------+----------------+--------------+
